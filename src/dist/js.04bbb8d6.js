...
var DataElectronics = function DataElectronics(props) {
...
var _DataElectronics = require("./DataElectronics");
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this._handleQuery = _this._handleQuery.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: "_handleQuery",
    value: function _handleQuery(event) {
      this.setState({
