...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/Card.jsx":[function(require,module,exports) {
'use strict';
...
var Card = function Card(_ref) {
    var pokemon = _ref.pokemon,
        catchPokemon = _ref.catchPokemon;

    return _react2.default.createElement(
        'div',
        { className: 'card ' + (pokemon.jname ? 'caught' : '') },
        _react2.default.createElement('img', { src: pokemon.picture, alt: '' }),
        _react2.default.createElement(
            'h4',
            { className: 'name' },
            pokemon.name
        ),
        pokemon.jname ? _react2.default.createElement(
            'span',
            null,
            pokemon.jname
        ) : _react2.default.createElement(
            ...
            { onClick: function onClick() {
                    return catchPokemon(pokemon.id);
                } },
            'Catch!'
        )
    );
...
},{"react":"../node_modules/react/index.js"}],"js/Search.jsx":[function(require,module,exports) {
'use strict';
...
var Search = function Search(props) {
    return _react2.default.createElement(
        'form',
        { className: 'search', onSubmit: props.searchPokemon },
        _react2.default.createElement('input', {
            value: props.search.name,
            onChange: function onChange(event) {
                return props.handleSearchChange('name', event.target.value);
            },
            type: 'text',
            placeholder: 'name'
        }),
        _react2.default.createElement('input', {
            ...
            onChange: function onChange(event) {
                return props.handleSearchChange('minHp', event.target.value);
            },
            type: 'number',
            min: '0',
            placeholder: 'minHp'
...
},{"react":"../node_modules/react/index.js"}],"js/Application.jsx":[function(require,module,exports) {
'use strict';
...
var Application = function (_React$Component) {
    ...
    function Application(props) {
        ...
        _this._catchPokemon = _this._catchPokemon.bind(_this);
        _this._searchPokemon = _this._searchPokemon.bind(_this);
    ...
    _createClass(Application, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('https://ironhack-pokeapi.herokuapp.com/pokemon').then(function (result) {
                _this2.setState({ pokemon: result.data, loading: false });
            }).catch(console.error);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var mappedPokemon = this.state.pokemon.filter(function (el, index) {
                return index < 21;
            }).map(function (el) {
                return _react2.default.createElement(_Card2.default, { pokemon: el, catchPokemon: _this3._catchPokemon, key: el.id });
            });
            return _react2.default.createElement(
                'div',
                { className: 'container' },
        ...
        key: '_searchPokemon',
        value: function _searchPokemon(event) {
            var _this4 = this;

            event.preventDefault();
            _axios2.default.get('https://ironhack-pokeapi.herokuapp.com/pokemon?name=' + this.state.search.name + '&minHp=' + this.state.search.minHp).then(function (_ref) {
                var data = _ref.data;
        ...
        value: function _handleSearchChange(key, value) {
            var newSearch = _extends({}, this.state.search);
        ...
        key: '_catchPokemon',
        value: function _catchPokemon(id) {
            var _this5 = this;

            if (Math.random() < 0.8) return;

            _axios2.default.get('https://ironhack-pokeapi.herokuapp.com/pokemon/' + id).then(function (_ref2) {
                var data = _ref2.data;

                _this5.setState({
                    pokemon: _this5.state.pokemon.map(function (el) {
...
},{"react":"../node_modules/react/index.js","axios":"../node_modules/axios/index.js","./Card":"js/Card.jsx","./Search":"js/Search.jsx"}],"js/index.js":[function(require,module,exports) {
'use strict';
...
_reactDom2.default.render(_react2.default.createElement(_Application2.default, null), appContainer);
},{"react-dom":"../node_modules/react-dom/index.js","react":"../node_modules/react/index.js","./Application":"js/Application.jsx"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/js.3780eea4.map